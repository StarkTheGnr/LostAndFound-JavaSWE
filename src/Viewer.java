...
public class Viewer {
	...
	public static boolean ShowItems()
	{
		for (int i = 0;i<Items.size();i++)
		{
			...
			System.out.print("Items's loacation latitude: " + Items.get(i).getLocation().latitude + " , longitude : " + Items.get(i).getLocation().longitude +" , altitude : " + Items.get(i).getLocation().altitude + "\n");
